...
def subscribe(request, form_class=PlanForm):
    ...
    if form.is_valid():
        ...
        try:
            ...
            bar.is_enabled = True;
            bar.save()
            messages.success(request, "You have successfully subscribed and your WiggleBar has been activated!")
            return HttpResponseRedirect(reverse("edit_bar", kwargs={'pk': bar.id}))
        except:
            messages.success(request, "You have successfully subscribed! Time to create your WiggleBar!")
